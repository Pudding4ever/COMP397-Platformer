var scenes;
(function (scenes) {
    class Play4Scene extends objects.Scene {
        // Public Properties
        // Constructor
...
#####################################################################`;
                ...
                for (let chr of this.row) {
                    switch (chr) {
                        ...
                        case chr = 'e':
                            {
                                //place minor enemy
                                let newenemy = new objects.BossEnemy(this.assetManager);
                                newenemy.x = this.x * scale;
                                newenemy.y = this.y * scale;
        ...
        // Public Methods
        UpdateLabels() {
            this._healthLabel.x = this.stage.regX;
            this._healthLabel.y = this.stage.regY + 0;
            this._weaponLabel.x = this.stage.regX;
            this._weaponLabel.y = this.stage.regY + 15;
            this._grenadeLabel.x = this.stage.regX;
